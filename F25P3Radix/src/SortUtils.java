...
public class SortUtils
{
    ...
    {
        Files
            .copy(Paths.get(sourcePath), new FileOutputStream(destinationPath));
    }


    // ----------------------------------------------------------
    /**
     * Compare that two files are identical Can't use Java Files::mismatch
     * because that is in Java 12, and all the alternatives that I've found boil
     * down to reading and comparing the contents something like this.
     * 
     * @param file1
     *            First file
     * @param file2
